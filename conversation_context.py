...
class ConversationContextManager:
    ...
    GREETING_KEYWORDS = [
        ...
        "naber", "nasilsin", "nasılsın", "sa", "as", "selamlar", "slm"
    ]
                ...
                with open(self.session_file, 'r', encoding='utf-8') as f:
                    ...
                    if session.last_updated:
                        ...
                        if hours_passed >= self.SESSION_TIMEOUT_HOURS:
                            print(f"⏰ {hours_passed:.1f} saat geçmiş - yeni session başlatılıyor")
    ...
    def _is_greeting_after_break(self, message: str) -> bool:
        """
        Mesaj selamlama mı VE uzun ara var mı kontrol et.
        Uyku sonrası yeni session başlatmak için kullanılır.
        ...
        try:
            ...
            for greeting in self.GREETING_KEYWORDS:
                if msg_lower.startswith(greeting) or msg_lower == greeting:
                    print(f"   ⏰ Son mesajdan {hours_passed:.1f} saat geçmiş + selamlama tespit edildi")
                    return True
